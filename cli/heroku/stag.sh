...
heroku config:set username=tmmbefrcztvgkg
heroku config:set password=7db47765147900fa98da631976f81b0372675153d288002ff386f8529a9281db
heroku config:set host=ec2-174-129-252-252.compute-1.amazonaws.com
heroku config:set port=5432
heroku config:set database=d6170o3ua6urrm